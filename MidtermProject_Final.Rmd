...
```{r, fig.height=7, fig.width=14, fig.cap="Density of fuel type and transmission using original data and log data"}
...
```{r, fig.height=5, fig.width=10, fig.cap="Different vehicle class vs. different transmission, cylinders and fuel type"}
grid.arrange(stackplot4,stackplot5,stackplot6,nrow=1)
```
