...
ggplot(data=co2_final, aes(x=CO2Emissions)) +
    geom_histogram(binwidth=5, fill="#000099", color="#e9ecef") +
...
Corrplot_data <- transform(Corrplot_data,EngineSize=as.numeric(EngineSize),
...
chart.Correlation(Corrplot_final, histogram=TRUE, pch=19)
```
