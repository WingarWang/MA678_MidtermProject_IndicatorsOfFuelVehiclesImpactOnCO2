...
```{r, echo=FALSE, fig.height=6, fig.width= 10,fig.cap="xxx"}
# variable "Make" barplot
ggplot(data=Make_amount,aes(x=Count, y=Make)) +
  geom_bar(stat='identity',fill=rainbow(n=length(Make_amount$Make))) +
  labs("Brand","Amount of vehicle",title = "The amount of vehicle in different brands")
```
